...
@section('styles')
    <link rel="stylesheet" href="{{ asset('css/admin/torneos.css') }}">
@endsection
...
<div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
    <h2 class="fw-bold d-flex align-items-center text-primary title-principal">
        <i data-lucide="trophy" class="me-2 icono-titulo"></i>
        Lista de Torneos
    </h2>
</div>
...
<div class="card border-0 shadow-lg" style="background-color: transparent;">
    <div class="table-responsive rounded-2">
        <table id="torneosTable" class="table align-middle mb-0 w-100">
...
<div class="modal fade" id="modalImagenTorneo" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content" style="background-color:#262421;color:white;border:1px solid rgba(255,255,255,0.1);">
      <div class="modal-header border-bottom">
        <h5 class="modal-title d-flex align-items-center gap-2" id="torneoModalLabel">
        ...
        <form id="torneoForm">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select id="tipo_evento_id" class="form-control required" disabled></select>
                </div>
            </div>
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <label class="form-label m-0">Categorías del torneo</label>
                    <button type="button" class="btn btn-sm btn-outline-success" id="addCategoriaTorneo">
                        + Agregar categoría
                    </button>
                </div>
                <div id="categoriasTorneoContainer" class="row g-3"></div>
            </div>
...
@push('scripts')
<script src="{{ asset('js/admin/torneos/torneos.js') }}"></script>
<script src="{{ asset('js/admin/torneos/media.js') }}"></script>
<script src="{{ asset('js/admin/torneos/documentos.js') }}"></script>
