<footer class="bg-dark-chess text-secondary py-5 mt-auto border-top border-secondary">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <ul class="list-unstyled small">
                    <li class="mb-2"><i class="bi bi-geo-alt me-2 text-chess-green"></i>Villavicencio, Meta</li>
                    <li class="mb-2"><i class="bi bi-envelope me-2 text-chess-green"></i>contacto@ligameta.com</li>
                    <li class="mb-2"><i class="bi bi-whatsapp me-2 text-chess-green"></i>+57 300 123 4567</li>
                </ul>
            </div>
        </div>
